Feature: Manage meetings
  ...
  Scenario: Register new meeting
    ...
    When I follow "Edit"
    And I select "1 Jan 2009 - 31 Dec 2009" from "Period"
    And I fill in "Starts at" with "16 Jan 2009 16:00:00"
    And I fill in "Ends at" with "16 Jan 2009 18:00:00"
    And I fill in "Location" with "Red Room"
    And I press "Update"
    Then I should see "Meeting was successfully updated."
    And I should see "Committee: Favorite Committee"
    And I should see "Period: 1 Jan 2009 - 31 Dec 2009"
