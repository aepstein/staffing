...
#    And I should <create> "Download Empl Id Directory"
  ...
  Scenario: Register new committee
    ...
    And I fill in "Contact name" with "Officials"
    And I fill in "Contact email" with "officials@example.com"
    ...
    And I should see "Contact name: Officials"
    And I should see "Contact email: officials@example.com"
    ...
    And I fill in "Contact name" with "Boss"
    And I fill in "Contact email" with "boss@example.com"
    And I choose "Yes"
    ...
    And I should see "Contact name: Boss"
    And I should see "Contact email: boss@example.com"
