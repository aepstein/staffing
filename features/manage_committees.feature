Feature: Manage committees
  ...
  Scenario: Register new committee
    ...
    And a logo exists with name: "Prestigious"
    And a logo exists with name: "Silly"
    ...
    And I select "Prestigious" from "Logo"
    ...
    And I should see "Logo: Prestigious"
