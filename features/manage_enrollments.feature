Feature: Manage enrollments
  ...
  Scenario: Register new enrollment
    ...
    And I choose "enrollment_membership_notices_true"
    And I choose "enrollment_manager_true"
    And I press "Create"
    ...
    And I choose "enrollment_membership_notices_false"
    And I choose "enrollment_manager_false"
    And I press "Update"
